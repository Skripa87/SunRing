...
namespace UfaSmartCity.Models
{
    ...
    {
        public static HtmlString Dropdown(string id, string ajaxId, List<SelectListItem> selectListItems, string label,
                                             ...
                                             ViewContext viewContext, ViewDataDictionary dataDictionary)
        {
            ...
            if (selectListItems.Count > 0)
            {
                ...
                dropdown.InnerHtml.Append(selectListItems.FirstOrDefault(s => s.Selected)?.Text + " ");
            }
            ...
            dropdown.InnerHtml.AppendHtml(BuildCaret(id));
            wrapper.InnerHtml.AppendHtml(dropdown);
            wrapper.InnerHtml.AppendHtml(BuildDropdown(id, ajaxId, selectListItems, urlAction, controllerHeadObjectId,
                                            ...
                                            ViewDataDictionary dataDictionary)
        {
            ...
            foreach (var item in items)
            {
                ...
                list.InnerHtml.AppendHtml("<li role=\"presentation\">" + BuildListRow(id, ajaxId, formId, item, urlAction, controllerHeadObjectId,
                                           ...
                                           ViewDataDictionary dataDictionary)
        {
            ...
            else
            {
                ...
                //form.InnerHtml.AppendHtml(token);
            ...
            if (form != null)
            {
                form.InnerHtml.AppendHtml(anchor);
